...
if (!$sloodle_course->controller->load($sloodlecontrollerid)) throw new \moodle_exception('Failed to load Controller data');
...
//
$PAGE->set_url('/mod/sloodle/classroom/notecard_configuration_view.php', $urlparams);
...
sloodle_add_to_log($course->id, 'classroom_log', 'classroom/notecard_configuration.php', array('sloodlecontrollerid'=>$sloodlecontrollerid,'sloodleobjtype'=>$sloodleobjtype), 'view sloodle config');
