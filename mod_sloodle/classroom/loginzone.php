...
sloodle_add_to_log($course->id, 'classroom_log', 'classroom/loginzone.php', array('id'=>$course->id), 'view loginzone');

//
$PAGE->set_url('/mod/sloodle/classroom/loginzone.php', $urlparams);
